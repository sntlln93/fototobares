...
class ProductionStatusStockableController extends Controller
{
     ...
     */
    public function store(StoreProductionStatusStockableRequest $request, ProductionStatus $productionStatus): \Illuminate\Http\RedirectResponse
    {
    ...
    public function destroy(ProductionStatus $productionStatus, Stockable $stockable): \Illuminate\Http\RedirectResponse
    {
