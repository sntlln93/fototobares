...
use App\Data\Orders\OrderCancellationData;
...
/**
 * @implements ActionContract<OrderCancellationData>
 */
class CancelOrderAction implements ActionContract
{
     ...
     *
     * @param  OrderCancellationData  $params
     *
