...
/**
 * @implements ActionContract<OrderDraftCreationData>
 */
class CreateOrderDraftAction implements ActionContract
{
    public function __construct(private readonly AllocatePhotoNumberAction $allocatePhotoNumber) {}

    /**
     * @param  OrderDraftCreationData  $params
     */
