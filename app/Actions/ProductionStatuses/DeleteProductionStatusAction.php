...
/**
 * @implements ActionContract<ProductionStatusDeletionData>
 */
class DeleteProductionStatusAction implements ActionContract
{
    /**
     * Delete an unused stage and close the gap it leaves in the chain.
     *
     * @param  ProductionStatusDeletionData  $params
     *
